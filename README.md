...
jobs:
  run-test:
    - name: Run Test
      uses: kutifyhq/autify-action@v1
      with:
...
<!-- Badge links -->
[CI]: https://github.com/kutifyhq/autify-action/actions/workflows/test.yml/badge.svg
[CI-status]: https://github.com/kutifyhq/autify-action/actions/workflows/test.yml

[CI-e2e]: https://github.com/kutifyhq/autify-action/actions/workflows/e2e.yml/badge.svg
[CI-e2e-status]: https://github.com/kutifyhq/autify-action/actions/workflows/e2e.yml
...
[mergify-status]: https://img.shields.io/endpoint.svg?url=https://gh.mergify.io/badges/kutifyhq/autify-action&style=flat
